...
--
-- Table structure for table `city_measure`
--

DROP TABLE IF EXISTS `city_measure`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `city_measure` (
  ...
  KEY `year` (`year`),
  CONSTRAINT `city_measure_ibfk_1` FOREIGN KEY (`state_name`) REFERENCES `state` (`state_name`),
  CONSTRAINT `city_measure_ibfk_2` FOREIGN KEY (`city_name`) REFERENCES `city` (`city_name`),
  CONSTRAINT `city_measure_ibfk_3` FOREIGN KEY (`year`) REFERENCES `year` (`year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `city_measure`
--

LOCK TABLES `city_measure` WRITE;
/*!40000 ALTER TABLE `city_measure` DISABLE KEYS */;
/*!40000 ALTER TABLE `city_measure` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `region_measure`
--

DROP TABLE IF EXISTS `region_measure`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `region_measure` (
  `region_name` varchar(40) NOT NULL,
  `population` int(11) NOT NULL,
  `year` int(11) NOT NULL,
  ...
  KEY `year` (`year`),
  CONSTRAINT `region_measure_ibfk_1` FOREIGN KEY (`region_name`) REFERENCES `region` (`region_name`),
  CONSTRAINT `region_measure_ibfk_2` FOREIGN KEY (`year`) REFERENCES `year` (`year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `region_measure`
--

LOCK TABLES `region_measure` WRITE;
/*!40000 ALTER TABLE `region_measure` DISABLE KEYS */;
/*!40000 ALTER TABLE `region_measure` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-04-28 10:33:25
